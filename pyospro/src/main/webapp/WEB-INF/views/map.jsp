...
<script type="text/javascript" src="//dapi.kakao.com/v2/maps/sdk.js?appkey=baabc568be3e54f4ba27b22c4f4b3626&libraries"></script>
<script>
...
var mapContainer = document.getElementById('map'), // 지도를 표시할 div 
    mapOption = { 
        center: new kakao.maps.LatLng(37.566404, 126.901763), // 지도의 중심좌표
        level: 7 // 지도의 확대 레벨
    };
